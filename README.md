...
- _Node.js_ & _npm_ (For developers to run the app locally)
...
_(Note: Make sure to allow camera permissions when the browser prompts you to use the core face recognition functionality.)_
